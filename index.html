...
<html lang="en">
  <head>
    ...
    <meta property="og:description" content="CDS stands for Crypto Development Services, This Connector Adds the POLYGON (MATIC) mainnet to metamask if you don't already have it along with Crypto Development Services and logo" />
              ...
              <div class="tm-section-wrap">
                <section id="intro" class="tm-section">
                    <div class="tm-bg-grey-transparent tm-intro">
                      <h2 class="tm-section-title mb-5 text-uppercase tm-color-primary">Get connected to the POLYGON (MATIC) Network and add Crypto Development Services</h2>
                        <ul class="list-steps">
                          <li class="list-steps__item wow fadeInLeftSmall" data-wow-delay=".1s">
                            ...
                            <div class="list-steps__item-main">
                              <h4><a href="#">MetaMask one click and add</a></h4>
                                <button class="connectMetaMask">Enable POLYGON (MATIC) & Add CDS</button>
                            </div>
                          </li>
                        </ul>
                    </div>
                ...
                <footer>
                  <div class="footer-content">
                    ...
                    <div class="company-name">
                      <span style="color:#000"> Did you know, We have a <a href="https://cryptodevelopmentservices.github.io/CDS_MetaMask_Connector/" target="_blank">Binance Smart Chain </a> <img src="./img/bnb.png" width="20px"> and a <a href="https://cryptodevelopmentservices.github.io/CDS_MetaMask_Connector_AVAX/" target="_blank">Avalanche </a> <img src="./img/avax.png" width="20px"> version of this connector</span> <br>
